...
--
-- Class LeaderboardEntry as table leaderboard_entry
--
...
--
-- Foreign relations for "leaderboard_entry" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('project_thera', '20260118201244199', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260118201244199', "timestamp" = now();
